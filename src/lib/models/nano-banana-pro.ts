...
export const nanoBananaProProvider: ImageModelProvider = {
  id: "nano-banana-pro",
  name: "Nano Banana Pro",
  description: "High-quality image generation via Gemini 2.5 Pro with 4K support",
  ...
  async generateImage(prompt: string, apiKey: string): Promise<string> {
    ...
    console.log(`Calling Nano Banana Pro (${MODEL_NAME}) for Image...`);
  ...
  async editImage(
    ...
    console.log(`Calling Nano Banana Pro (${MODEL_NAME}) for Image Edit...`);
