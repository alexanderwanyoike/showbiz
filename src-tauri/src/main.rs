...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Bibles
            commands::bibles::get_bibles,
            commands::bibles::create_bible,
            commands::bibles::update_bible,
            commands::bibles::delete_bible,
            commands::bibles::get_bible_assets,
            commands::bibles::create_bible_asset,
            commands::bibles::update_bible_asset,
            commands::bibles::delete_bible_asset,
            commands::bibles::get_bible_asset_variants,
            commands::bibles::create_bible_asset_variant,
            commands::bibles::update_bible_asset_variant_status,
            commands::bibles::delete_bible_asset_variant,
            commands::bibles::get_bible_variant_image_base64,
            commands::bibles::get_storyboard_bibles,
            commands::bibles::attach_storyboard_bible,
            commands::bibles::detach_storyboard_bible,
            commands::bibles::get_shot_asset_refs,
            commands::bibles::set_shot_asset_refs,
            commands::bibles::create_bible_snapshot,
            commands::bibles::get_bible_snapshots,
            // Shots
