...
import type { ImageVersionNodeWithUrl } from "../actions/image-version-actions";
...
function flattenTree(
  nodes: ImageVersionNodeWithUrl[]
): ImageVersionNodeWithUrl["version"][] {
  const result: ImageVersionNodeWithUrl["version"][] = [];
